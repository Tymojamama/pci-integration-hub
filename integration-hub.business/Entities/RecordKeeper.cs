...
{
    public class RecordKeeper : IDatabaseEntity
    {
        #region PublicMembers

        public Guid RecordKeeperId { get; private set; }
        public Guid ModifiedBy { get; private set; }
        public Guid CreatedBy { get; private set; }

        public string Name { get; private set; }
        public string RfpContactName { get; private set; }
        public string RfpContactEmail { get; private set; }
        ...
        public RecordKeeper(Guid _recordKeeperId)
        {
            this.RecordKeeperId = _recordKeeperId;
            ...
            this.RfpContactName = _dataRow["PrimaryRfpContactName"].ToString();
            this.RfpContactEmail = _dataRow["PrimaryRfpContactEmail"].ToString();
        ...
        private DataTable GetDetailsFromId()
        {
            ...
            parameterList.Add("@RecordKeeperId", this.RecordKeeperId);

            // Execute stored procedure and return datatable result
            return Database.DataIntegrationHub.ExecuteStoredProcedureQuery("[dbo].[usp_RecordKeeperGetDetailsFromId]", parameterList);
        }

        public static DataTable GetAll()
        {
            return Database.DataIntegrationHub.ExecuteStoredProcedureQuery("[dbo].[usp_RecordKeeperGetAll]");
        }
    }
}
