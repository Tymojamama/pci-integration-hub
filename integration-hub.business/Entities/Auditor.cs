...
{
    public class Auditor : IDatabaseEntity
    {
        ...
        public Auditor(Guid _auditorId)
        {
        ...
        private DataTable GetDetailsFromId()
        {
            ...
            parameterList.Add("@AuditorId", this.AuditorId);

            // Execute stored procedure and return datatable result
            return Database.DataIntegrationHub.ExecuteStoredProcedureQuery("[dbo].[usp_AuditorGetDetailsFromId]", parameterList);
        }

        public static DataTable GetAll()
        {
            return Database.DataIntegrationHub.ExecuteStoredProcedureQuery("[dbo].[usp_AuditorGetAll]");
        }
    }
}
